            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold text-cream">Qiadat</h3>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Empowering volunteers in Oman. Connect, share, and impact the society through our initiatives.
                        </p>
                    </div>

                    {/* Quick Links */}
                    <div>
                        <h4 className="font-semibold text-lg mb-4 text-cream">Quick Links</h4>
                        <ul className="space-y-2 text-sm text-gray-300">
                            <li><Link href="/about" className="hover:text-cream transition-colors">About Us</Link></li>
                            <li><Link href="/objectives" className="hover:text-cream transition-colors">Objectives</Link></li>
                            <li><Link href="/services" className="hover:text-cream transition-colors">Services</Link></li>
                            <li><Link href="/partners" className="hover:text-cream transition-colors">Our Partners</Link></li>
                        </ul>
                    </div>

                    {/* Contact Info */}
                    <div>
                        <h4 className="font-semibold text-lg mb-4 text-cream">Contact Us</h4>
                ...
                <div className="border-t border-white/10 pt-6 text-center text-sm text-gray-500">
                    © {new Date().getFullYear()} Oman Volunteer Center. All rights reserved.
                </div>
            </div>
        </footer>
    );
